...
describe('ContentCatalogueService', () => {
  let service: ContentCatalogueService;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [ContentCatalogueService],
    }).compile();

    service = module.get<ContentCatalogueService>(ContentCatalogueService);
