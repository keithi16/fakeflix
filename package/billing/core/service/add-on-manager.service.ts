...
export class AddOnManagerService {
  ...
  async addAddOn(
    ...
    const existingAddOns =
      await this.subscriptionAddOnRepository.findActiveBySubscriptionId(subscription.id);
  ...
  async removeAddOn(
    ...
    const subscriptionAddOn =
      await this.subscriptionAddOnRepository.findActiveBySubscriptionIdAndAddOnId(
        subscription.id,
        addOnId
      );
