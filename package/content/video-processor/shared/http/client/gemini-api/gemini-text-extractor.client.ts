...
} from '../../../../age-recommendation/core/adapter/video-recommendation.adapter.interface';
...
export class GeminiTextExtractorClient
  implements
    ...
    VideoAgeRecommendationAdapter
{
  constructor(private readonly configService: ConfigService<ContentConfig>) {}
  ...
  private async performRequest<T>(
    ...
    const ai = new GoogleGenAI({
      apiKey: this.configService.get('content.geminiApi.apiToken'),
    });
