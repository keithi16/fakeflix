...
## Fakeflix-Specific Considerations

When creating TDDs for Fakeflix projects, consider:
...
- **Communication**: Inter-module communication via HTTP/GraphQL (never direct DB)
...
- [ ] Uses HTTP/GraphQL for inter-module communication (Explicit Communication - Principle 5)
...
- Confirm transaction decorators specify correct connection
